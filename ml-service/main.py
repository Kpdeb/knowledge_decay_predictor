...
Exposes /predict endpoint consumed by the backend.
"""
...
from prediction.predictor import predict_retention

app = FastAPI(
    title="Knowledge Decay ML Service",
    description="Random Forest + Logistic Regression retention predictor",
    version="1.0.0",
)
